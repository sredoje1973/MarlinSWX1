...
#define STRING_CONFIG_H_AUTHOR "(Artillery Sidewinder X1, SKR1.4 Hemera)" // Who made the changes. //sv
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V1_4_TURBO //sv
#endif
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT -1 //sv:leaving a port open
...
#define CUSTOM_MACHINE_NAME "Sidewinder X1" //sv
 ...
 */
#define X_DRIVER_TYPE  TMC2209 //sv
#define Y_DRIVER_TYPE  TMC2209 //sv
#define Z_DRIVER_TYPE  TMC2209 //sv
...
#define E0_DRIVER_TYPE TMC2209 //sv
...
#define TEMP_SENSOR_BED 1// SV: heated bed change to 1 to enable
...
#define HEATER_0_MAXTEMP 300 //sv
 ...
 */
#define PIDTEMPBED //sv:need PID tempbed for SKR
  ...
  #define DEFAULT_bedKp 244.21 //sv:skr
  #define DEFAULT_bedKi 45.87 //sv:skr
  #define DEFAULT_bedKd 325.08 //sv:skr
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW //sv:skr not sensorless 
#define X_MAX_ENDSTOP_HIT_STATE HIGH
#define Y_MIN_ENDSTOP_HIT_STATE LOW  //sv:skr not sensorless , using LOW to indicate a hit
#define Y_MAX_ENDSTOP_HIT_STATE HIGH
#define Z_MIN_ENDSTOP_HIT_STATE HIGH
#define Z_MAX_ENDSTOP_HIT_STATE LOW //sv I hope this does Z_MIN_ENDSTOP_INVERTING false //sv:skr + bltouch 
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE HIGH //sv:skr + bltouch 
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.52, 80.85, 401.20, 409}  //sv:SKR hemera steps
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 40, 40 } //sv
 ...
 */
#define DEFAULT_ACCELERATION         800   //sv:skr  // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  10000 //sv:skr      // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION    2000  //sv:skr     // X, Y, Z acceleration for travel (non printing) moves
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //sv

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING //sv:skr + bltouch
 ...
 */
#define Z_MIN_PROBE_PIN P0_10 //sv:skr + bltouch
 ...
 *     O-- FRONT --+
 */
 //************** if inverting your motor direction, then must invert the values for offsets (i.e. - becomes +)
#define NOZZLE_TO_PROBE_OFFSET { 63, -23, 0 } //sv:skr + hemera, x should be 63 
...
#define PROBING_MARGIN 20 //sv

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (6*60) //sv: set to 6*60
...
#define PROBE_OFFSET_XMIN -65  // (mm) //sv: set for hemera probe mount
#define PROBE_OFFSET_XMAX  65   // (mm) //sv: set for hemera probe mount
...
#define INVERT_X_DIR true //sv:skr sw
#define INVERT_Y_DIR  true  //sv:skr sw
#define INVERT_Z_DIR false //sv:skr sw
...
#define INVERT_E0_DIR false //sv: setting to false for Hemera
...
#define X_BED_SIZE 300 // sv:Skr,SW 
#define Y_BED_SIZE 285 // sv:Skr,SW , because of hemera mount lose a bit of Y axis
...
#define Z_MAX_POS 400 //sv:SKR,SW
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define AUTO_BED_LEVELING_BILINEAR //sv
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //sv:skr
 ...
 */
#define EEPROM_SETTINGS  //sv     // Persistent storage with M500 and M501
...
#define PREHEAT_1_TEMP_HOTEND 200 //sv
#define PREHEAT_1_TEMP_BED     60 //sv
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PETG" //sv
#define PREHEAT_2_TEMP_HOTEND 230 //sv
#define PREHEAT_2_TEMP_BED    60  //sv
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER  //sv:skr, removing this???
